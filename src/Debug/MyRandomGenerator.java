...
public class MyRandomGenerator {
    public static Transaction generateTransaction(int id, ObservableList<Category> categories){
        ...
        String note = "DEBUG";
        return new Transaction(id, amount, categories.get(category), date.getTime(), note);
    }
